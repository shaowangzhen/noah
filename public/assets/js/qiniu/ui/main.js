    ...
    var uploader = Qiniu.uploader({
        ...
        init: {
            ...
            'FileUploaded': function(up, file, info) {
                ...
                $('#long_video_url').val(infoObj.key);
                $('#long_video_modified').val(1);
            },
            ...
            'Key': function(up, file) {
                ...
                var key = getNowFormatDate() + generateMixed(32) + '.' + getFileExt(file.name);
                return key;
            }
        }
    });
    ...
    var uploader2 = Q2.uploader({
        ...
        init: {
            ...
            'FileUploaded': function(up, file, info) {
                ...
                progress.setComplete(up, info);
                var infoObj = $.parseJSON(info);
                $('#short_video_url').val(infoObj.key);
                $('#short_video_modified').val(1);
            },
            'Error': function(up, err, errTip) {
                $('table').show();
                var progress = new FileProgress(err.file, 'fsUploadProgress');
