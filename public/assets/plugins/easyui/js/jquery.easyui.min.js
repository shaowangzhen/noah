...
_ae4(_ad9,_adf,_ada.remainText);
...
vv=vv.concat(opts.unselectedValues);
_ae4(_ae2,vv,_ae3.remainText);
};
function _ae4(_ae5,_ae6,_ae7){
var _ae8=$.data(_ae5,"combotreegrid");
...
$.fn.combotreegrid=function(_aed,_aee){
if(typeof _aed=="string"){
var _aef=$.fn.combotreegrid.methods[_aed];
if(_aef){
return _aef(this,_aee);
}else{
return this.combo(_aed,_aee);
}
}
_aed=_aed||{};
return this.each(function(){
var _af0=$.data(this,"combotreegrid");
if(_af0){
$.extend(_af0.options,_aed);
}else{
_af0=$.data(this,"combotreegrid",{options:$.extend({},$.fn.combotreegrid.defaults,$.fn.combotreegrid.parseOptions(this),_aed)});
}
_ad8(this);
});
};
$.fn.combotreegrid.methods={options:function(jq){
var _af1=jq.combo("options");
return $.extend($.data(jq[0],"combotreegrid").options,{width:_af1.width,height:_af1.height,originalValue:_af1.originalValue,disabled:_af1.disabled,readonly:_af1.readonly});
},grid:function(jq){
return $.data(jq[0],"combotreegrid").grid;
},setValues:function(jq,_af2){
return jq.each(function(){
var opts=$(this).combotreegrid("options");
if($.isArray(_af2)){
_af2=$.map(_af2,function(_af3){
if(_af3&&typeof _af3=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_af3);
return _af3[opts.idField];
}else{
return _af3;
}
});
...
},setValue:function(jq,_af4){
return jq.each(function(){
$(this).combotreegrid("setValues",$.isArray(_af4)?_af4:[_af4]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotreegrid.parseOptions=function(_af5){
var t=$(_af5);
return $.extend({},$.fn.combo.parseOptions(_af5),$.fn.treegrid.parseOptions(_af5),$.parser.parseOptions(_af5,[]));
};
$.fn.combotreegrid.defaults=$.extend({},$.fn.combo.defaults,$.fn.treegrid.defaults,{editable:false,singleSelect:true,unselectedValues:[],mappingRows:[]});
})(jQuery);
(function($){
function _af6(_af7){
var _af8=$.data(_af7,"datebox");
var opts=_af8.options;
$(_af7).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_af9(this);
_afa(this);
_afb(this);
_b09(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_af8.calendar){
var _afc=$(_af7).combo("panel").css("overflow","hidden");
_afc.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_afc);
...
_af8.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_af8.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _afd=this.target;
var opts=$(_afd).datebox("options");
_b09(_afd,opts.formatter.call(_afd,date));
$(_afd).combo("hidePanel");
opts.onSelect.call(_afd,date);
}});
}
$(_af7).combo("textbox").parent().addClass("datebox");
$(_af7).datebox("initValue",opts.value);
function _af9(_afe){
var opts=$(_afe).datebox("options");
var _aff=$(_afe).combo("panel");
_aff.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _b00=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_b00].handler.call(e.target,_afe);
}
});
};
function _afa(_b01){
var _b02=$(_b01).combo("panel");
if(_b02.children("div.datebox-button").length){
return;
}
var _b03=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_b02);
var tr=_b03.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text)?btn.text(_b01):btn.text).appendTo(td);
...
var cc=_b05.children("div.datebox-calendar-inner");
_b05.children()._outerWidth(_b05.width());
_af8.calendar.appendTo(cc);
_af8.calendar[0].target=_b04;
if(opts.panelHeight!="auto"){
var _b06=_b05.height();
_b05.children().not(cc).each(function(){
_b06-=$(this).outerHeight();
});
cc._outerHeight(_b06);
}
_af8.calendar.calendar("resize");
};
};
function _b07(_b08,q){
_b09(_b08,q,true);
};
function _b0a(_b0b){
var _b0c=$.data(_b0b,"datebox");
var opts=_b0c.options;
var _b0d=_b0c.calendar.calendar("options").current;
if(_b0d){
_b09(_b0b,opts.formatter.call(_b0b,_b0d));
$(_b0b).combo("hidePanel");
}
};
function _b09(_b0e,_b0f,_b10){
var _b11=$.data(_b0e,"datebox");
var opts=_b11.options;
var _b12=_b11.calendar;
_b12.calendar("moveTo",opts.parser.call(_b0e,_b0f));
if(_b10){
$(_b0e).combo("setValue",_b0f);
}else{
if(_b0f){
_b0f=opts.formatter.call(_b0e,_b12.calendar("options").current);
}
$(_b0e).combo("setText",_b0f).combo("setValue",_b0f);
}
};
$.fn.datebox=function(_b13,_b14){
if(typeof _b13=="string"){
var _b15=$.fn.datebox.methods[_b13];
if(_b15){
...
_b13=_b13||{};
return this.each(function(){
var _b16=$.data(this,"datebox");
if(_b16){
$.extend(_b16.options,_b13);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_b13)});
}
_af6(this);
});
};
...
return $.extend($.data(jq[0],"datebox").options,{width:_b17.width,height:_b17.height,originalValue:_b17.originalValue,disabled:_b17.disabled,readonly:_b17.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
},initValue:function(jq,_b18){
return jq.each(function(){
var opts=$(this).datebox("options");
var _b19=opts.value;
if(_b19){
_b19=opts.formatter.call(this,opts.parser.call(this,_b19));
}
$(this).combo("initValue",_b19).combo("setText",_b19);
});
...
$.fn.datebox.parseOptions=function(_b1b){
return $.extend({},$.fn.combo.parseOptions(_b1b),$.parser.parseOptions(_b1b,["sharedCalendar"]));
};
...
_b07(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_b1c){
return $(_b1c).datebox("options").currentText;
},handler:function(_b1d){
var now=new Date();
$(_b1d).datebox("calendar").calendar({year:now.getFullYear(),month:now.getMonth()+1,current:new Date(now.getFullYear(),now.getMonth(),now.getDate())});
_b0a(_b1d);
}},{text:function(_b1e){
return $(_b1e).datebox("options").closeText;
},handler:function(_b1f){
...
(function($){
function _b20(_b21){
var _b22=$.data(_b21,"datetimebox");
var opts=_b22.options;
$(_b21).datebox($.extend({},opts,{onShowPanel:function(){
var _b23=$(this).datetimebox("getValue");
_b29(this,_b23,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_b21).removeClass("datebox-f").addClass("datetimebox-f");
$(_b21).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_b22.spinner){
var _b24=$(_b21).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_b24.children("div.datebox-calendar-inner"));
_b22.spinner=p.children("input");
}
_b22.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator});
$(_b21).datetimebox("initValue",opts.value);
};
function _b25(_b26){
var c=$(_b26).datetimebox("calendar");
var t=$(_b26).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _b27(_b28,q){
_b29(_b28,q,true);
};
function _b2a(_b2b){
var opts=$.data(_b2b,"datetimebox").options;
var date=_b25(_b2b);
_b29(_b2b,opts.formatter.call(_b2b,date));
$(_b2b).combo("hidePanel");
};
function _b29(_b2c,_b2d,_b2e){
var opts=$.data(_b2c,"datetimebox").options;
$(_b2c).combo("setValue",_b2d);
if(!_b2e){
if(_b2d){
var date=opts.parser.call(_b2c,_b2d);
$(_b2c).combo("setText",opts.formatter.call(_b2c,date));
$(_b2c).combo("setValue",opts.formatter.call(_b2c,date));
}else{
$(_b2c).combo("setText",_b2d);
}
}
var date=opts.parser.call(_b2c,_b2d);
$(_b2c).datetimebox("calendar").calendar("moveTo",date);
$(_b2c).datetimebox("spinner").timespinner("setValue",_b2f(date));
function _b2f(date){
function _b30(_b31){
return (_b31<10?"0":"")+_b31;
};
var tt=[_b30(date.getHours()),_b30(date.getMinutes())];
if(opts.showSeconds){
tt.push(_b30(date.getSeconds()));
}
return tt.join($(_b2c).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_b32,_b33){
if(typeof _b32=="string"){
var _b34=$.fn.datetimebox.methods[_b32];
if(_b34){
return _b34(this,_b33);
}else{
return this.datebox(_b32,_b33);
}
}
_b32=_b32||{};
return this.each(function(){
var _b35=$.data(this,"datetimebox");
if(_b35){
$.extend(_b35.options,_b32);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_b32)});
}
_b20(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _b36=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_b36.originalValue,disabled:_b36.disabled,readonly:_b36.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_b37){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _b38=opts.value;
if(_b38){
_b38=opts.formatter.call(this,opts.parser.call(this,_b38));
}
$(this).combo("initValue",_b38).combo("setText",_b38);
});
},setValue:function(jq,_b39){
return jq.each(function(){
_b29(this,_b39);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_b3a){
var t=$(_b3a);
return $.extend({},$.fn.datebox.parseOptions(_b3a),$.parser.parseOptions(_b3a,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_b27(this,q);
}},buttons:[{text:function(_b3b){
return $(_b3b).datetimebox("options").currentText;
},handler:function(_b3c){
var opts=$(_b3c).datetimebox("options");
_b29(_b3c,opts.formatter.call(_b3c,new Date()));
$(_b3c).datetimebox("hidePanel");
}},{text:function(_b3d){
return $(_b3d).datetimebox("options").okText;
},handler:function(_b3e){
_b2a(_b3e);
}},{text:function(_b3f){
return $(_b3f).datetimebox("options").closeText;
},handler:function(_b40){
$(_b40).datetimebox("hidePanel");
}}],formatter:function(date){
var h=date.getHours();
var M=date.getMinutes();
var s=date.getSeconds();
function _b41(_b42){
return (_b42<10?"0":"")+_b42;
};
var _b43=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_b41(h)+_b43+_b41(M);
...
var _b44=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_b44);
var hour=parseInt(tt[0],10)||0;
var _b45=parseInt(tt[1],10)||0;
var _b46=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_b45,_b46);
}});
})(jQuery);
(function($){
function init(_b47){
var _b48=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_b47);
var t=$(_b47);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_b48.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_b48.bind("_resize",function(e,_b49){
if($(this).hasClass("easyui-fluid")||_b49){
_b4a(_b47);
}
return false;
});
...
var _b4d=$.data(_b4b,"slider");
var opts=_b4d.options;
var _b4e=_b4d.slider;
if(_b4c){
if(_b4c.width){
opts.width=_b4c.width;
}
if(_b4c.height){
opts.height=_b4c.height;
}
}
_b4e._size(opts);
if(opts.mode=="h"){
_b4e.css("height","");
_b4e.children("div").css("height","");
}else{
_b4e.css("width","");
_b4e.children("div").css("width","");
_b4e.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_b4e._outerHeight());
}
_b4f(_b4b);
};
function _b50(_b51){
var _b52=$.data(_b51,"slider");
var opts=_b52.options;
var _b53=_b52.slider;
...
_b54(aa);
function _b54(aa){
var rule=_b53.find("div.slider-rule");
var _b55=_b53.find("div.slider-rulelabel");
rule.empty();
_b55.empty();
for(var i=0;i<aa.length;i++){
var _b56=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_b56);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_b55);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_b56,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_b56,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _b57(_b58){
var _b59=$.data(_b58,"slider");
var opts=_b59.options;
var _b5a=_b59.slider;
_b5a.removeClass("slider-h slider-v slider-disabled");
_b5a.addClass(opts.mode=="h"?"slider-h":"slider-v");
_b5a.addClass(opts.disabled?"slider-disabled":"");
var _b5b=_b5a.find(".slider-inner");
_b5b.html("<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_b5b.append("<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_b5a.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_b59.isDragging=true;
opts.onSlideStart.call(_b58,opts.value);
},onStopDrag:function(e){
_b5d(opts.mode=="h"?e.data.left:e.data.top,this);
opts.onSlideEnd.call(_b58,opts.value);
opts.onComplete.call(_b58,opts.value);
_b59.isDragging=false;
}});
_b5a.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_b59.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_b5d(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_b58,opts.value);
});
function _b5d(pos,_b5e){
var _b5f=_b60(_b58,pos);
var s=Math.abs(_b5f%opts.step);
if(s<opts.step/2){
_b5f-=s;
}else{
_b5f=_b5f-s+opts.step;
}
if(opts.range){
var v1=opts.value[0];
var v2=opts.value[1];
...
if(_b5e){
var _b61=$(_b5e).nextAll(".slider-handle").length>0;
if(_b5f<=v2&&_b61){
v1=_b5f;
}else{
if(_b5f>=v1&&(!_b61)){
...
_b5f<m?v1=_b5f:v2=_b5f;
}
}
}
$(_b58).slider("setValues",[v1,v2]);
}else{
$(_b58).slider("setValue",_b5f);
}
};
};
function _b62(_b63,_b64){
var _b65=$.data(_b63,"slider");
var opts=_b65.options;
var _b66=_b65.slider;
var _b67=$.isArray(opts.value)?opts.value:[opts.value];
var _b68=[];
if(!$.isArray(_b64)){
_b64=$.map(String(_b64).split(opts.separator),function(v){
return parseFloat(v);
});
}
_b66.find(".slider-value").remove();
var name=$(_b63).attr("sliderName")||"";
...
var _b6a=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_b66);
_b6a.attr("name",name);
_b6a.val(_b69);
_b68.push(_b69);
var _b6b=_b66.find(".slider-handle:eq("+i+")");
var tip=_b6b.next();
var pos=_b6c(_b63,_b69);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_b63,_b69));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _b6d="left:"+pos+"px;";
_b6b.attr("style",_b6d);
tip.attr("style",_b6d+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _b6d="top:"+pos+"px;";
_b6b.attr("style",_b6d);
tip.attr("style",_b6d+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?_b68:_b68[0];
$(_b63).val(opts.range?_b68.join(opts.separator):_b68[0]);
if(_b67.join(",")!=_b68.join(",")){
opts.onChange.call(_b63,opts.value,(opts.range?_b67:_b67[0]));
}
};
function _b4f(_b6e){
var opts=$.data(_b6e,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_b62(_b6e,opts.value);
opts.onChange=fn;
};
function _b6c(_b6f,_b70){
var _b71=$.data(_b6f,"slider");
var opts=_b71.options;
var _b72=_b71.slider;
var size=opts.mode=="h"?_b72.width():_b72.height();
var pos=opts.converter.toPosition.call(_b6f,_b70,size);
if(opts.mode=="v"){
pos=_b72.height()-pos;
}
if(opts.reversed){
...
function _b60(_b73,pos){
var _b74=$.data(_b73,"slider");
var opts=_b74.options;
var _b75=_b74.slider;
var size=opts.mode=="h"?_b75.width():_b75.height();
var pos=opts.mode=="h"?(opts.reversed?(size-pos):pos):(opts.reversed?pos:(size-pos));
var _b76=opts.converter.toValue.call(_b73,pos,size);
return _b76.toFixed(0);
};
$.fn.slider=function(_b77,_b78){
if(typeof _b77=="string"){
return $.fn.slider.methods[_b77](this,_b78);
}
_b77=_b77||{};
return this.each(function(){
var _b79=$.data(this,"slider");
if(_b79){
$.extend(_b79.options,_b77);
}else{
_b79=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_b77),slider:init(this)});
$(this).removeAttr("disabled");
}
...
_b62(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
...
$.fn.slider.parseOptions=function(_b7d){
var t=$(_b7d);
return $.extend({},$.parser.parseOptions(_b7d,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_b7e){
return _b7e;
},converter:{toPosition:function(_b7f,size){
var opts=$(this).slider("options");
return (_b7f-opts.min)/(opts.max-opts.min)*size;
},toValue:function(pos,size){
var opts=$(this).slider("options");
return opts.min+(opts.max-opts.min)*(pos/size);
}},onChange:function(_b80,_b81){
},onSlideStart:function(_b82){
},onSlideEnd:function(_b83){
},onComplete:function(_b84){
}};
})(jQuery);
